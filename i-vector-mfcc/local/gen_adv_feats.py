...
def main(args):
	...
	adv_featsfile = 'ark:| copy-feats ark: ark,scp:'+cpath+'/data/voxceleb1_test/spoofed_feats_sigma'+str(args.sigma)+'.ark,'+cpath+'/data/voxceleb1_test/spoofed_feats_sigma'+str(args.sigma)+'.scp'
	utts_done = 0
