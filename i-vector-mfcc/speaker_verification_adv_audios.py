...
parser.add_argument('--expt-rstfile', type=str, default='exp/lpms_ivec_adv_verification_scores_sigma')
...
# sigma = sys.argv[1]
# fgmmfile = 'exp/full_ubm/final_ubm.txt'
# datafile = 'data/all_adv_stft_sigma'+sigma+'/voiced_feats.scp'               ###############################################
# ivectorfile = 'exp/extractor/extractor.txt'
# pldamdlfile = 'exp/ivectors_train/plda.txt'
# enrollscpfile = 'exp/ivectors_voxceleb1_test/ivector.scp'
# trialsfile = 'data/voxceleb1_test/trials_adv_all'                      ##############################
# expt_rstfile = 'exp/score_all_adv_stft_sigma'+sigma                         ###################################
# ivector_global_meanfilename = 'exp/ivectors_train/mean.vec'
