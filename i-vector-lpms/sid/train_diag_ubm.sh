...
if $apply_cmn; then
  all_feats="ark,s,cs:select-voiced-frames scp:$data/feats.scp scp,s,cs:$data/vad.scp ark:- |"
  feats="ark,s,cs:select-voiced-frames scp:$sdata/JOB/feats.scp scp,s,cs:$sdata/JOB/vad.scp ark:- | subsample-feats --n=$subsample ark:- ark:- |"
else
  all_feats="ark,s,cs:select-voiced-frames scp:$data/feats.scp scp,s,cs:$data/vad.scp ark:- |"
  feats="ark,s,cs:select-voiced-frames scp:$sdata/JOB/feats.scp scp,s,cs:$sdata/JOB/vad.scp ark:- | subsample-feats --n=$subsample ark:- ark:- |"
fi
