...
from preprocess.generic import load_wav_snf, stft, save_wav, \
     revert_power_db_to_wav, uttid2wav, load_wav, save_wav_snf, extract_adv_mat_frm_grads
...
def main(args):
	...
	# print(1+args.sigma)
	keys, mat_list = extract_adv_mat_frm_grads(args.grads, args.vad, args.ori_feats, args.sigma, target=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', default="adv_audios_target/sigma", type=str) ############################
