...
def main(args):
	...
	# print(1+args.sigma)
	keys, mat_list = extract_adv_voiced_feats(args.grads, args.vad, args.ori_feats, args.sigma, target=True)
	adv_featsfile = 'ark:| copy-feats ark: ark,scp:data/voxceleb1_test/spoofed_target_voiced_feats_sigma'+str(args.sigma)+'.ark,data/voxceleb1_test/spoofed_target_voiced_feats_sigma'+str(args.sigma)+'.scp'
	utts_done = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--grads', 
        default="data/voxceleb1_test/gradientfile_target.scp", type=str)
